...
DD1D is a "dungeon crawl" of sorts. Players go from room to room, solving problems and fighting against things that want to eat them. At the table IRL, the "dungeon rooms" would be laid out like the hours of a clock using tarot cards from a **Map Deck**. The digital companion constructs the Map Deck automatically, but if you'd like to play at home you can build your own by:
1. Putting nine random Major Arcana cards into a face-down pile and shuffle.
2. Putting one random card from each Minor Arcana suit into a second face-down pile and shuffle.
